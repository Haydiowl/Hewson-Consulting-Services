  ...
  return (
    <div className="[word-break:break-word] content-stretch flex gap-[20px] items-center justify-center leading-[0] not-italic py-[20px] relative shrink-0 text-[20px] w-full whitespace-nowrap" data-name="Nav links">
      ...
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#232323]">
        <p className="[text-underline-position:from-font] decoration-from-font decoration-solid leading-[1.218] underline">Services</p>
      </div>
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-end relative shrink-0 text-[#565966]">
...
function Section() {
  return (
    <div className="bg-white content-stretch flex h-[152px] items-center justify-center overflow-clip px-[40px] py-[16px] relative shrink-0 w-full" data-name="Section">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[1.7] min-w-px not-italic relative text-[#363b4b] text-[20px] text-justify">Hewson Consulting offers management support packages and strategic due diligence. Our services help operators solve business and technical issues stretching across general CRE operations, strategy, info systems, project analytics and resource provision. Our business service division and technical support division offer a one-stop solution center.</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] not-italic relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#191b23] text-[20px] whitespace-nowrap">
        <p className="leading-[1.218]">{`Market Research & Planning`}</p>
      </div>
      <ul className="block font-['Inter:Medium',sans-serif] font-medium list-disc min-w-full relative shrink-0 text-[#40434d] text-[16px] text-justify w-[min-content]">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Market research & industry trend analysis`}</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Project development & feasibility appraisal`}</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[1.7]">{`Business plan formulation & refinement`}</span>
        </li>
      </ul>
    </div>
  );
...
function Type() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip px-[16px] py-[28px] relative rounded-[15px]" data-name="Type 1">
      <Frame3 />
    </div>
  );
}
...
function Type1() {
  return (
    <div className="[word-break:break-word] bg-white content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start leading-[0] min-w-px not-italic overflow-clip px-[16px] py-[28px] relative rounded-[15px]" data-name="Type 2">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#191b23] text-[20px] whitespace-nowrap">
        <p className="leading-[1.218]">Corporate Vision</p>
      </div>
      <ul className="block font-['Inter:Medium',sans-serif] font-medium list-disc min-w-full relative shrink-0 text-[#40434d] text-[16px] text-justify w-[min-content]">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Property marketing & sales effectiveness`}</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Strategy formulation & market entry approach`}</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[1.7]">{`Corporate image promotion & branding`}</span>
        </li>
      </ul>
    </div>
  );
...
function Type2() {
  return (
    <div className="[word-break:break-word] bg-white content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start leading-[0] min-w-px not-italic overflow-clip px-[16px] py-[28px] relative rounded-[15px]" data-name="Type 3">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#191b23] text-[20px] whitespace-nowrap">
        <p className="leading-[1.218]">{`Process Management & Staffing`}</p>
      </div>
      <ul className="block font-['Inter:Medium',sans-serif] font-medium list-disc min-w-full relative shrink-0 text-[#40434d] text-[16px] text-justify w-[min-content]">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Process management & workflow design`}</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Capacity development & manpower training`}</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[1.7]">{`Executive search & technical recruitment`}</span>
        </li>
      </ul>
    </div>
  );
...
function Wrapper() {
  return (
    <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Wrapper">
      <Type />
      <Type1 />
      <Type2 />
    </div>
...
function Section1() {
  return (
    <div className="bg-[#f8f9fa] content-stretch flex flex-col gap-[16px] items-center justify-center overflow-clip pt-[24px] px-[40px] relative shrink-0 w-full" data-name="Section 2">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end leading-[0] not-italic relative shrink-0 text-[#232323] text-[22px] w-full">
        <ol className="list-decimal" start="1">
          <li className="ms-[33px]">
            <span className="leading-[1.218]">Our Business Support Services</span>
          </li>
        </ol>
      </div>
      <Wrapper />
...
function Type3() {
  return (
    <div className="[word-break:break-word] bg-white content-stretch flex flex-[1_0_0] flex-col gap-[12px] items-start leading-[0] min-w-px not-italic overflow-clip px-[24px] py-[28px] relative rounded-[15px]" data-name="Type 1">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#191b23] text-[20px] whitespace-nowrap">
        <p className="leading-[1.218]">{`CRE Systems & IT Integration`}</p>
      </div>
      <ul className="block font-['Inter:Medium',sans-serif] font-medium list-disc min-w-full relative shrink-0 text-[#40434d] text-[16px] text-justify w-[min-content]">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Real-estate process & digitalization support`}</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Software development & website construction`}</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[1.7]">{`System transformation & enterprise scaling`}</span>
        </li>
      </ul>
    </div>
  );
...
function Frame4() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start leading-[0] not-italic relative shrink-0 w-full">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#191b23] text-[20px] whitespace-nowrap">
        <p className="leading-[1.218]">{`Asset Valuations & Advisory`}</p>
      </div>
      <ul className="block font-['Inter:Medium',sans-serif] font-medium list-disc min-w-full relative shrink-0 text-[#40434d] text-[16px] text-justify w-[min-content]">
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Real-estate portfolio & investment auditing`}</span>
        </li>
        <li className="mb-0 ms-[24px]">
          <span className="leading-[1.7]">{`Business Enterprise & tangible asset valuations`}</span>
        </li>
        <li className="ms-[24px]">
          <span className="leading-[1.7]">{`Spatial locational analysis & highest best use`}</span>
        </li>
      </ul>
    </div>
  );
...
function Type4() {
  return (
    <div className="bg-white content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip px-[24px] py-[28px] relative rounded-[15px]" data-name="Type 3">
      <Frame4 />
    </div>
  );
}
...
function Section2() {
  return (
    <div className="bg-[#f8f9fa] content-stretch flex flex-col gap-[16px] items-center justify-center overflow-clip px-[40px] py-[24px] relative shrink-0 w-full" data-name="Section 3">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end leading-[0] not-italic relative shrink-0 text-[#232323] text-[22px] w-full">
        <ol className="list-decimal" start="2">
          <li className="ms-[33px]">
            <span className="leading-[1.218]">Our Technical Support Services</span>
          </li>
        </ol>
      </div>
      <Frame2 />
...
function Sectiom() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[20px] items-start justify-center leading-[0] not-italic overflow-clip px-[40px] py-[32px] relative shrink-0 w-full" data-name="Sectiom">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end relative shrink-0 text-[#232323] text-[22px] w-full">
        <ol className="list-decimal" start="3">
          <li className="ms-[33px]">
            <span className="leading-[1.218]">Our Service Outline</span>
          </li>
        </ol>
      </div>
      <div className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#363b4b] text-[20px] w-full">
        <p className="leading-[1.87] mb-0 whitespace-pre-wrap">Our services help organizations to overcome critical pain points:</p>
        <ul className="leading-[1.87] list-disc">
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#191b23]">Issue Resolution:</span>
            {` Identifying management issues that stall growth and implementing fitted solutions, staffing & training that aligns with goals.`}
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">Strategy Formulation:</span>
            {` Working with C-suite executives to build strategy for seamless market penetration and impactful sales outcome that boost profile.`}
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">IT Optimization:</span>
            {` Streamlining workflow and deploying smart solutions to ensure that technology enables asset management and effective reporting`}
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">Project De-Risking:</span>
            {` Utilizing complex analytics and appraisal methods to detect risk contingencies early in the project lifecycle and protect capital.`}
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">Finance Brokerage:</span>
            {` Assisting clients to package bankable documents including project viability reports required by institutions for granting loan.`}
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">Skill Development:</span>
            {` Conducting training sessions that eliminate skill deficiency geared towards higher productivity across technical and strategic areas `}
          </li>
          <li className="mb-0 ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">Sales Enhancement:</span>
            {` Preparing pre-sales pitch, marketing mix and brand framework for companies beside carrying out effective sales training`}
          </li>
          <li className="ms-[30px]">
            <span className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold not-italic text-[#232323]">Growth Structuring:</span>
            {` Creating the structures for businesses to expand, and leverage on existing properties as resources for acquisition of further assets`}
          </li>
        </ul>
      </div>
    </div>
...
function Section3() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-name="Section 3">
      <Sectiom />
    </div>
  );
}
...
function Section4() {
  return (
    <div className="[word-break:break-word] bg-[#f8f9fa] content-stretch flex flex-col gap-[12px] items-start justify-center not-italic overflow-clip px-[40px] py-[32px] relative rounded-[10px] shrink-0 w-full" data-name="Section 4">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-end leading-[0] relative shrink-0 text-[#232323] text-[22px] w-full">
        <ol className="list-decimal" start="4">
          <li className="ms-[33px]">
            <span className="leading-[1.218]">Our Enterprise CRE Support Services</span>
          </li>
        </ol>
      </div>
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[1.7] relative shrink-0 text-[#363b4b] text-[20px] text-justify w-full">Hewson Consulting offers management support packages and strategic due diligence. Our services help operators solve business and technical issues stretching across general CRE operations, strategy, info systems, project analytics and resource provision. Our business service division and technical support division offer a one-stop solution center.</p>
    </div>
  );
}
...
export default function Services() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="SERVICES">
      <NavBar />
      <Hero />
      <NavLinks />
      <Frame />
